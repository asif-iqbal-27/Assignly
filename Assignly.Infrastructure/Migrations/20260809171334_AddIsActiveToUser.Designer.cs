...
namespace Assignly.Infrastructure.Migrations
{
    ...
    [Migration("20260809171334_AddIsActiveToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignly.Domain.Entities.Submission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Assignly.Domain.Entities.TeacherSubjectAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Assignly.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.HasOne("Assignly.Domain.Entities.ApplicationUser", "CreatedByTeacher")
                        .WithMany()
                        .HasForeignKey("CreatedByTeacherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Assignly.Domain.Entities.Subject", "Subject")
                        .WithMany("Assignments")
            ...
            modelBuilder.Entity("Assignly.Domain.Entities.Submission", b =>
                {
                    b.HasOne("Assignly.Domain.Entities.Assignment", "Assignment")
                        .WithMany("Submissions")
                        .HasForeignKey("AssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignly.Domain.Entities.ApplicationUser", "GradedByTeacher")
                        .WithMany()
                        .HasForeignKey("GradedByTeacherId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Assignly.Domain.Entities.ApplicationUser", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Assignly.Domain.Entities.TeacherSubjectAssignment", b =>
                {
                    ...
                    b.HasOne("Assignly.Domain.Entities.ApplicationUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Assignly.Domain.Entities.ApplicationUser", null)
                        .WithMany()
